...
accrate.depth <- function(depth, yrcm=FALSE, prob=.95)
  {
...
accrate.age <- function(age, yrcm=FALSE, prob=.95)
  {
    accrate <- c()
    for(i in 1:ncol(chron))
      {
...
# welcome
setwd("/Users/Gastorga/Documents/Thesis_GA/second_chapter/data_second/clam/Cores/Dobson/")
getwd()
source("clam.R")
cat("Hi there, welcome to clam for age-depth modellingn")
setwd("/Users/Gastorga/Dropbox/chapter2_15_may_2015/data_second/clam")
source("clam.R")
clam("Dobson", cc=3, type=4, smooth=0.2, its=10000, depths.file=T, revaxes=T, revyr=F, revd=F)
...
calibrate(14805)
calibrate(14550)
calibrate(12555,error=35)  # Lake Dobson bt Rees et al
calibrate(11600, error=150)
calibrate(12960, error = 950) # Colhoun 1985
calibrate(12840, error = 30)
calibrate(13220, error = 30) # Platypus Tarn
calibrate(12200)
calibrate(13400)
calibrate(13000)
calibrate(12400)
...
calibrate(11100)
calibrate(11500)
calibrate(11400) # HMCR
calibrate(10800)
calibrate(10200) # HMCR
calibrate(9800)
calbrate()
calibrate(8300)
calibrate(12000)
...
calibrate(1500)
calibrate(12960,950)
calibrate(2555,20,reservoir=40)
clam(Dobson)
